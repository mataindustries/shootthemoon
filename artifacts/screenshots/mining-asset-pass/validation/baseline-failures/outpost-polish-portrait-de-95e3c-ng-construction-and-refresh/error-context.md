...
```
Error: mining-laser-beam must clear the HUD
  ...
  - generic:
    ...
    - region "Outpost status":
      - generic:
        - generic: LUNAR ORE
        - strong: "60.6"
      - generic: LASER EXTRACTING ORE · BETA
    - region "Outpost operations" [ref=f1e10]:
      ...
      - generic [ref=f1e17]:
        ...
        - generic [ref=f1e30]:
          ...
          - strong [ref=f1e32]: 60.6 / 240
          - generic [ref=f1e33]: LUNAR ORE
      - region "Orbital Siege" [ref=f1e34]:
        - generic [ref=f1e35]:
          - generic [ref=f1e36]: ORBITAL SIEGE
          - strong [ref=f1e37]: ORBITAL PLATFORM OBJECTIVE
        - paragraph [ref=f1e38]: Build an orbital logistics relay. +20% ore delivery when operational.60 stored ore · 6 kW reserved · 2 of 3 robots. No defense reserve; 1 miner with −25% ore delivery during assembly.
        - button "BUILD ORBITAL PLATFORM · 60 ORE" [disabled] [ref=f1e39]
        - generic [ref=f1e40]: Requires 60 ore, 8 kW solar capacity, idle miner and completed module work.
      - group [ref=f1e41]:
        - generic "Operating mode" [ref=f1e42]:
          - button "CONSERVE" [ref=f1e43] [cursor=pointer]
          - button "BALANCED" [pressed] [ref=f1e44] [cursor=pointer]
          - button "OVERDRIVE" [ref=f1e45] [cursor=pointer]
        - generic [ref=f1e46]:
          - generic [ref=f1e47]: OUTPOST TIER 2
          - strong [ref=f1e48]: SOLAR WING
      - button "BETA · MINE DEPOSIT" [disabled] [ref=f1e49]
      - button "RETURN TO ORBIT" [ref=f1e50] [cursor=pointer]
```
